...
export function TopNavigation() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 h-14 sm:h-16 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 flex items-center justify-between px-4 sm:px-6 ml-[var(--sidebar-width,256px)] transition-all duration-300">
